...
class ObservableAppState extends EventEmitter {
  ...
  jumbles = [
    ...
    new Jumble({ name: '🦧 Crazy Jumble', body: "Oranges, apples, and bananas danced together in the bowl, creating a harmonious fruit salad. With each keystroke, the orangutan got closer to becoming a typing virtuoso. Hungry for success? Keep peeling away at those keys until you're the fastest typist in the jungle!" })
  ]
  /**@type {Jumble} */
  activeJumble = null
}
